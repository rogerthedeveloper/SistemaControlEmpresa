            ...
            <br>
                ...
                <div style="text-align: center;">
                    ...
                    <button id="new" type="button" class="new btn btn-success btn-md">
                     ...
                     <button id="create" type="button" class="createCliente btn btn-primary btn-md btn-md">
        ...
        <?php if($options["photo"] == true): ?>
            ...
            <div class="col-md-4">
                ...
                <div class="well">
                  ...
                  <img id="client-img" class="form_image" src="../assets/img/no_pic.jpg">


                    <video id="capturar-foto" autoplay></video>
                        ...
                        <button onclick="showCam(true); EnableUpdatePic(true);" style="margin-top: 10px;" type="button" class="update-pic btn btn-info btn-md" disabled>
                            <span class="glyphicon glyphicon-camera" aria-hidden="true"></span> Ver Cámara
                        </button>


                        <button style="margin-top: 10px;" type="button" class="updatetake-pic btn btn-success btn-md" disabled>
                            <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Actualizar
                        </button>
...
$("button.createCliente").on("click", function()  {
